          ...
          {filteredAppointments.map((item) => {
            ...
            return (
              ...
              >
                ...
                {/* Ações do Tutor no Agendamento Ativo: Chat e Cancelar */}
                {!display.isCancelled && item.ops_status !== "finalizado" && item.status !== "concluido" && (
                  <div className="mt-2.5 flex items-center justify-end gap-2 pt-2 border-t border-current/15">
                    <Button
                      type="button"
                      variant="outline"
                      size="sm"
                      className="h-7 rounded-lg text-xs font-bold gap-1.5 bg-background/80 hover:bg-background border-border/80 shadow-xs"
                      onClick={() =>
                        openInAppChat({
                    ...
                    <Button
                      ...
                      variant="ghost"
                      size="sm"
                      className="h-7 rounded-lg text-xs font-bold text-rose-600 hover:bg-rose-50 hover:text-rose-700 dark:text-rose-400 dark:hover:bg-rose-950/50 gap-1"
                      onClick={() => {
